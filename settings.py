...
PARTICLE_CHANCE: int = 3  # The lower this value, the higher the chance that a star appears
MAX_ENEMIES: int = 5  # The maximum amount of enemies on the screen
MIN_FPS: float = 120  # Minimum frames per second
MAX_FPS: float = 210  # Maximum frames per second
...
MID_Y: float = HEIGHT / 2  # The middle of the canvas (don't change this!)
MID_X: float = WIDTH / 2  # The middle of the canvas (don't change this!)
